...
class UserVerifications extends Authenticatable
{
    ...
    protected $fillable = [
        'name', 'email', 'mobile', 'age', 'profile','gender','refer_code','referred_by','profession_id','datetime','points','total_points','state','city','unique_name','verified','last_seen','online_status','cover_img','dummy','introduction','message_notify','add_friend_notify','view_notify','profile_verified','cover_img_verified','verification_end_date','verification_status','selfi_image','proof_image', // Add 'mobile' to the fillable fields
    ];
